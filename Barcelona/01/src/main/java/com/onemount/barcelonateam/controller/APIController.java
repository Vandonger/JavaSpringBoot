...
public class APIController {
  ...
  */
  public TeamAndSubstitute substitude(@PathVariable int playerno, @PathVariable Position position) throws TeamException {
    TeamAndSubstitute teamAndSubstitute = new TeamAndSubstitute();
    teamAndSubstitute.setCurrentTeam((List<Player>) coachService.getCurrentTeam());
    teamAndSubstitute.setSubstituteHistory(coachService.subtitude(playerno, position));
